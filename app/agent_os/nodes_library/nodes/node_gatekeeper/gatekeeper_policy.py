...
class GatekeeperPolicy:
    ...
    competitor_names: tuple[str, ...] = (
        "ChatGPT", "OpenAI", "Gemini", "Copilot",
        "Grok", "Mistral", "Llama", "Perplexity",
    ...
    injection_signals: tuple[str, ...] = (
        ...
        "system prompt", "act as", "jailbreak", "bypass",
        "override instructions", "new persona", "pretend you are",
        "you are now", "developer mode", "dan mode",
        # Vietnamese
        "bỏ qua lệnh trước", "quên hướng dẫn", "giả vờ là",
        "vượt qua hệ thống",
    )

    vn_profanity: tuple[str, ...] = (
        # Explicit
        "cc", "cặc", "lồn", "đm", "đmm", "đcm", "vãi lồn",
        "dmm", "clgt", "đéo", "địt", "đụ",
        # Obfuscated
        "l**", "c**", "đ**", "c.c",
    )
