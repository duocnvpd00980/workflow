...
class AuditLogOutput(BaseModel):
    ...
    event_type: str = Field(..., description="Loại sự kiện hệ thống (ví dụ: workflow, tool_call, error)")
    actor: str = Field(..., description="Tác nhân thực thi hành động (ví dụ: system, user, agent_ads)")
