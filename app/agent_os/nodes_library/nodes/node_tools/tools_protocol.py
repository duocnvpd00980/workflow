...
class ToolsAdapterOutput(BaseModel):
    ...
    summary_of_findings: str = Field(..., description="Tóm tắt ngắn gọn các thông tin tìm thấy được")
    tokens_consumed: int = Field(default=0, description="Lượng token tiêu tốn để xử lý kết quả")
