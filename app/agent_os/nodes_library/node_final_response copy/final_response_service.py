...
class FinalResponseService:
    ...
    def _props_map(self, payload: BodyFrame) -> dict[ComponentId, dict[str, Any]]:
        ...
        return {
            ...
            "email_template": raw_email or {
                "subject": "Thông tin gửi tới bạn",
                "body":    text,
            },
            "blog_preview": raw_blog or {
                "title":   "Bài viết mới",
                "content": text,
            },
            "campaign_summary": {
...
def _handle_marketing(
    ...
    return self._render_many(selected, payload) if selected else [
        self._render_one("text_response", payload)
    ]
